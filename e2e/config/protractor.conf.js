...
exports.config = {
    ...
    cucumberOpts: {
        require: [
            path.resolve(process.cwd(), './e2e/config/helpers/*.ts'),
    ...
    onPrepare() {
        global.ngApimock = require(path.resolve(process.cwd(), './.tmp/ngApimock/protractor.mock.js'));
...
function getFeatureFiles() {
    return argv.feature
        ? argv.feature.split(',').map(feature => `${process.cwd()}/e2e/**/${feature}.feature`)
        : [`${process.cwd()}/e2e/**/*.feature`];
}
